...
namespace Bau.Libraries.LibRest.Http
{
    ...
    { ResponseMessage objResult;
		...
		/// </summary>
		private void AddHeaders(HttpWebRequest objHttpRequest, Messages.Headers.HeadersCollection objColHeaders)
		{	foreach (Messages.Headers.Header objHeader in objColHeaders)
